...
// const _input_box_translate_x = useRef(Value(width))
// const _back_button_opacity = useRef(Value(0))
// const _content_translate_y = useRef(Value(height))
// const _content_opacity = useRef(Value(0))
