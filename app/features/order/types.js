...
export const DELTE_SENDED_ITEMS = 'DELTE_SENDED_ITEMS';
export const POST_RATINGS = 'POST_RATING';
export const SET_CART_EMPTY_FROM_DETAILS = 'SET_CART_EMPTY_FROM_DETAIL';